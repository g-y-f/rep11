package com.rubik.framework.aspectj;
...
import com.rubik.common.enums.BusinessStatus;
import com.rubik.common.json.JSON;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.rubik.common.annotation.Log)")
