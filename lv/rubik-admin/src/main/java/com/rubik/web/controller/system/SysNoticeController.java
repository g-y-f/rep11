...
import com.rubik.system.domain.SysNotice;
import com.rubik.system.service.ISysNoticeService;
...
public class SysNoticeController extends BaseController {
    ...
    public AjaxResult addSave(SysNotice notice) {
        notice.setCreateBy(ShiroUtils.getUserName());
    ...
    public AjaxResult editSave(SysNotice notice) {
        notice.setUpdateBy(ShiroUtils.getUserName());
